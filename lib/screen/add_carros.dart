...
class AddCarros extends StatelessWidget {
  AddCarros({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              Text("Cadastro de Veículos para o frete:",
                  style: TextStyle(
